...
<head>
	...
	<title>Admin XYZ | @yield('title') </title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="/admin/dashboard" class="logo">
					<span style="color: white" >Aplikasi XYZ</span>
				</a>
						...
						<li class="nav-item {{ request()->is('admin/master/*') ? 'active' : '' }}">
							...
							<div class="collapse" id="charts">
								<ul class="nav nav-collapse">
									...
									<li class="{{ request()->is('admin/master/tanding') ? 'active' : '' }}">
										<a href="/admin/master/tanding" >
											<span class="sub-item">Data Tanding</span>
										</a>
									</li>
